...
portfolio:
  thesis: "사내 커머스 플랫폼의 제품 완성도를 뒷받침하기 위해 배포, 운영, 보안, 관측 가능성 기반을 정리한 DevSecOps 프로젝트입니다."
  value: "애플리케이션 기능이 실제 서비스처럼 운영될 수 있도록 플랫폼 레이어를 설계했습니다."
  problem: "사내 전용 커머스 플랫폼은 검색, 알림, 관리자 기능을 안정적으로 뒷받침할 수 있는 클라우드 인프라와 운영 체계가 필요했습니다."
  decisions:
    - label: "Platform foundation"
      description: "React와 Spring 기반 서비스가 배포, 운영, 모니터링 흐름 안에서 동작하도록 CI/CD와 클라우드 기반을 정리했습니다."
  outcome: "폐쇄형 사내 마일리지 몰을 위한 실무형 서비스 기반을 팀 프로젝트 안에서 구축했습니다."
  metrics:
    - label: "Foundation"
      value: "CI/CD + Cloud"
      context: "배포, 운영, 보안, 관측 가능성 기반"
resume:
  include: true
  priority: 80
featured: false
