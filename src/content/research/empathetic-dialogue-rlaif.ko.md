...
contributionClaim: "공감 대화 생성에서 인간 피드백 의존을 줄이기 위해 AI 피드백 기반 강화학습 구조를 제안했다."
methodSignal: "LLM 평가자를 보상 모델처럼 활용하고 PPO 기반 정책 업데이트로 응답 다양성과 공감 수준을 조정했다."
portfolioRelevance: "LLM 응답 품질을 프롬프트 결과가 아니라 평가자, 보상, 정책 업데이트가 연결된 시스템 판단으로 다뤄야 한다는 관점을 보강한다."
linkedRoles:
  - "nlp-llm"
bibtex: |
